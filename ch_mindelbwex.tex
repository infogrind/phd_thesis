...
\begin{figure}
  ...
  \hfil
  \subfloat[$\Delta =
  \beta^{-1}$]{\label{fig:sdrubproofb}\figbox[4cm]{sdrubproofb}}
  } % end centerline
  \caption{Geometrical view of the proofs of \lemref{lowerbound1} (left) and
  \lemref{lowerbound2} (right). In the former case, $s$ and $s + \Delta$ are
