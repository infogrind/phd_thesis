...
Based on the ideas outlined in the previous chapter, this section
...
use. The main idea behind this strategy goes back to McRae~\cite{McRae1971}; for
more detailed historical references see \secref{mindelbwexhist} at the end of
the chapter. \footnote{The main results of this chapter have been
published in~\cite{KleinerR2009b} and~\cite{KleinerR2010}.}
...
\begin{figure}
  ...
  \hfil
  \subfloat[Mapping proposed in \secref{commscheme}
