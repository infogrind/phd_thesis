...
categories: \emph{scheme classes} (or simply called 'schemes'), which are
classes that implement communication systems and have the class |Scheme| as
their common ancestor, and \emph{scheme processors}, which are classes that
implement the analysis of a particular aspect of a single or of a family of
communication schemes. Scheme processors derive from the common ancestor class
|SchemeProcessor|. 
...
to the mean square error that the scheme achieves with the given SNR.
...
are also calles \emph{member variables.}}) must derive from the |handle| class. 
