...
\begin{enumerate}
  ...
  \item The function |update_mse(obj)| (\lineref{20}) is the heart of this
...
\begin{method}{\meta{class name}(\oarg{sv}, \oarg{s}, \oarg{param}) (public)}
...
\begin{property}{legend (public; default |[]|)}
...
\begin{method}{set_color_mode(\obj, \oarg{c})}
