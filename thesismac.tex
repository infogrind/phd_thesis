...
% Various shorthands
\newcommand{\Sm}{S^{(m-1)}(1)}    % Unit sphere in m dimensions

% General parameters of a source-channel communication system
\newcommand{\pS}{{P_S}}
\newcommand{\px}{P_X}
\newcommand{\py}{P_Y}
\newcommand{\qx}{Q_X}
...
\DeclareMathOperator{\snr}{\abbrev{SNR}}
\DeclareMathOperator{\sdr}{\abbrev{SDR}}
\renewcommand\th{{\ensuremath{^{\text{th}}}}}
\newcommand{\matlab}{{\normalfont\textsf{MATLAB}}}
\newcommand{\pgfplots}{{\normalfont\textsc{pgfplots}}}
\newcommand{\jscsim}{{\normalfont\textsc{JSCsim}}}
% Redefine Memoir's fancy break command to use fleurons.
%\renewcommand{\pfbreakdisplay}{%
%\ding{167}\quad\ding{167}\quad\ding{167}}
\renewcommand{\pfbreakdisplay}{\ding{166}}
...
\newcommand{\bchapref}[1]{\textbf{\chapref{#1}}}
\newcommand{\lineref}[1]{line~#1}

% Shortcuts for varioref-style references
\newcommand{\exvref}[1]{Example~\vref{ex:#1}}
\newcommand{\figvref}[1]{Figure~\vref{fig:#1}}
\newcommand{\lstvref}[1]{Listing~\vref{lst:#1}}
\newcommand{\eqvref}[1]{Equation~\vref{eq:#1}}

% Used in distortion lower bound
\newcommand{\pmin}{{p_{\min}}}
\newcommand{\mse}{{\E[(\Sh - S)^2]}}
\newcommand{\mseq}{{\E[(\Qh - Q)^2]}}
\newcommand{\mseqiv}{{\E[\|\Qhv_i - \Q_i\|^2]}}
\newcommand{\msee}{{\E[(\Eh - E)^2]}}
\newcommand{\msev}{{\E[\|\Shv - \S\|^2]}}
\newcommand{\msecond}{{\E[(\Sh - S)^2 | s]}}
\newcommand{\msecondd}{{\E[(\Sh - S)^2 | s + \Delta]}}
\newcommand{\msecondxi}{{\E[(\Sh - S)^2 | \xi(s)]}}
...
\newcommand{\QLb}{{Q_{\Lambda/\beta}}}
\newcommand{\Ln}{{\Lambda_{n-1}}}
\newcommand{\Vx}{{V_{\vxi}}}
\newcommand{\Vd}{{V_{\Dv}}}
\newcommand{\fXv}{f_{\X}}
...
\begin{boxedminipage}[b]{#1}
  \centering\strut\par\path{fig:#2}\par\strut
\end{boxedminipage}}
