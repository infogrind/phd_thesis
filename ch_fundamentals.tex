...
the particular case of a Gaussian source and channel under squared error
distortion and an average transmit power constraint.  If the source and the
channel produce and transmit, respectively, symbols at the same rate, then
