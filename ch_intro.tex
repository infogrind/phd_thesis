...
\bchapref{fidelity} establishes an upper bound to the average fidelity per cost
...
\bchapref{delaygauss}, and it is shown how uncoded communication can be used
...
This hybrid strategy is described in detail in \bchapref{mindelbwex}, which
