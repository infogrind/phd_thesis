...
Allgemeinen nicht bekannt.  \looseness=-1
...
Leistungsbeschränkung unterliegt.\looseness=-1
...
% This kerning is the least amount needed to keep the complete keywords on the
% same page.
\kern-2pt
